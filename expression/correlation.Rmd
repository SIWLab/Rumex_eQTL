...
```{r}
p1 <- ggplot(sex_r_df, aes(x = spearman_r, colour = Category)) + geom_histogram(binwidth = 0.05, position = "identity", alpha = 0.5, fill = NA) + theme_classic() + labs(title = "a", x = "Pearson's r", y = "Count") + xlim(-1, 1) + ylim(0,1550) + scale_color_brewer(palette="Dark2")
p1
```
...
### plot the distribution of r
```{r}
p2 <- ggplot(pl_r_df, aes(x = spearman_r, colour = Category)) + geom_histogram(binwidth = 0.05, position = "identity", alpha = 0.5, fill=NA) + theme_classic() + labs(title = "b", x = "Pearson's r", y = "Count") + xlim(-1, 1) + ylim(0,1550) + scale_color_brewer(palette="Dark2")
p2
```
...
```{r}
p3 <- ggplot(egene_r, aes(x = spearman_r, colour = Category)) + geom_histogram(binwidth = 0.05, position = "identity", alpha = 0.5, fill=NA) + theme_classic() + labs(title = "b", x = "Pearson's r", y = "Count") + xlim(-1, 1) + scale_color_brewer(palette="Dark2")
p3
```
...
```{r}
p4 <- ggplot(all_r, aes(x = spearman_r, colour = Category)) + geom_histogram(binwidth = 0.05, position = "identity", alpha = 0.5, fill=NA) + theme_classic() + labs(title = "a", x = "Pearson's r", y = "Count") + xlim(-1, 1) + scale_color_brewer(palette="Dark2")
p4
```

```{r}
p4 + p3 + plot_layout(guides = 'collect')
ggsave(paste0(data, "phenotype_correlation_pearson_2.pdf"), height = 3.6, width = 7.5, units = "in")
```

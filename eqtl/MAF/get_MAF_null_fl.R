...
write.table(nrow(FL_eqtl_sig), file=paste0("FL_", i, "_random.cnt1"), row.names = FALSE, quote = FALSE,col.names = F)
...
write.table(nrow(FL_eqtl_sig_random_af), file=paste0("FL_", i, "_random.cnt2"), row.names = FALSE, quote = FALSE,col.names = F)

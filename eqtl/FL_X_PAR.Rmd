...
p_data1 <- get_hist_prop2(FL_eqtl_sig_random_af)
...
ggplot(p_data1, aes(x_axis, y_prop)) + 
    ...
    geom_point(data = p_data2, color = "pink", fill=NA, alpha = 0.6)+
    geom_point(data = p_data3, color = "lightblue", fill=NA, alpha = 0.6)+

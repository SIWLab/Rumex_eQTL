...
ml_fl$category <- factor(ml_fl$category)
levels(ml_fl$category) <- c("top in both", "top in FL, sig in ML", "top in FL, not sig in ML", "top in ML, sig in FL", "top in ML, not sig in FL")
...
# manually check annotation for the 9 etqls
```
both    leaf   leaf2  pollen pollen2 
      9       5     575       5     380 
 both    leaf   leaf2  pollen pollen2 

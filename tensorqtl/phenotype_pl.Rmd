...
write.table(normalized_counts_MPn_A4, file = paste0(data,"normalized_counts_MPn_A4.txt"), row.names = FALSE, quote = F)
write.table(normalized_counts_MLn_A4, file = paste0(data,"normalized_counts_MLn_A4.txt"), row.names = FALSE, quote = F)

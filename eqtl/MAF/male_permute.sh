...
expression_bed=/ohta2/meng.yuan/rumex/eqtl/tensorqtl/Male/normalized_counts_mln_auto_${i}.bed.gz
prefix=ML_${i}
...
plink_prefix_path=/ohta2/meng.yuan/rumex/eqtl/plink/MP
expression_bed=/ohta2/meng.yuan/rumex/eqtl/tensorqtl/Male/normalized_counts_mpn_auto_${i}.bed.gz
prefix=MP_${i}
covariates_file=/ohta2/meng.yuan/rumex/eqtl/tensorqtl/covariate_ML.txt
python3 -m tensorqtl ${plink_prefix_path} ${expression_bed} ${prefix} \
--covariates ${covariates_file} \

...
pl_eqtl_sig_min <- pl_eqtl_sig %>%
  ...
  slice_sample(n = 1) # 2029, 1540, 1564
...
egene <- as.data.frame(unique(pl_eqtl_sig$phenotype_id)) # 2029, 1540
colnames(egene) <- "gene" 
egene_overlap <- inner_join(egene, DE_tissue, by = "gene") # 1874, 1442
...
data:  t
X-squared = 44.288, df = 3, p-value = 1.311e-09

         all     egene
FC1  1.3029392 -4.830758
FC2  0.5011011 -1.857875
FC3 -0.4703268  1.743777
FC4 -0.9129066  3.384679
